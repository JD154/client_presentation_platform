...
import { DollarSign, Database, GitMerge, BarChart4, Server } from 'lucide-react'
  ...
  components: [
    {
      ...
      description:
        'Secure connection to QuickBooks Online via API for invoices, bills, and payments',
      icon: DollarSign,
      layer: 'source',
    },
    {
      ...
      description:
        'Direct access to operational data including job execution and asset tracking',
      icon: Server,
      layer: 'source',
    },
    {
      ...
      description:
        'Automated sync with retry logic, deduplication, and change detection',
      icon: GitMerge,
      layer: 'processing',
    },
    {
      ...
      description:
        'Normalized data from both systems with full history and audit trails',
      icon: Database,
      layer: 'storage',
    },
    {
      ...
      description:
        'Matching logic that connects financial records to operational events',
      icon: GitMerge,
      layer: 'processing',
    },
    {
      ...
      description:
        'Visual reports showing profitability, asset performance, and reconciliation',
      icon: BarChart4,
      layer: 'presentation',
    },
  ],
  ...
  return (
    <div className="relative flex flex-col min-h-screen p-8 bg-white">
      ...
      <div className="relative z-10 mb-6 text-center">
        ...
        >
          Clean, automated data flow connecting QuickBooks financial data with
          Haulink operations
        </motion.p>
      </div>
      ...
      >
        <AnimatedArchitectureDiagram onComplete={() => setShowDetails(true)} />
      </motion.div>
      ...
      {showDetails && (
        ...
        >
          {layers.map((layer, layerIndex) => {
            ...
            const componentsInLayer = content.components.filter(
              c => c.layer === layer
            )
            ...
            return componentsInLayer.map((component, index) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{
                    duration: 0.4,
                    delay: layerIndex * 0.1 + index * 0.1,
                  }}
                ...
                >
                  <div className="flex items-start">
                    <div
                      className={`p-2 rounded-lg ${layerStyle.bg} border ${layerStyle.border} mr-3 shrink-0`}
                    >
                      <Icon className={`w-5 h-5 ${layerStyle.color}`} />
                    </div>
                    <div>
                      <div
                        className={`text-xs font-bold uppercase tracking-wider ${layerStyle.color} mb-1`}
                      >
                        {layerStyle.label}
                      </div>
      ...
      {showDetails && (
        ...
        >
          <p className="text-lg font-medium text-gray-800">
            All components work together to provide real-time visibility into
